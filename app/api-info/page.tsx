...
const endpoints = [
  {
    ...
    details: "Upload a resume file and receive 56-field structured JSON with ATS compatibility score, quality grade (A–F), and per-field confidence scores. Powered by Claude AI — 92% overall confidence.",
  },
  {
    method: "POST",
...
# Response
{
  ...
  "data": {
    ...
    "programming_languages": ["TypeScript", "Node.js"]
  },
